...
# idf_file_name = r"C:\Users\danie\OneDrive\Dokumenter\MasterThesis\Test\ReMoni_OS_model.idf"  # building energy model (BEM) IDF file January
...
# Weather Path
# ep_weather_path = r"C:\Users\danie\OneDrive\Dokumenter\MasterThesis\Test\DNK_MJ_Aarhus_2007-2021.epw"  # EPW weather file january
...
cvs_output_path = r'C:\Users\danie\OneDrive\Dokumenter\MasterThesis\Test\dataframe_output_jan.csv'
...
# Should be same varialbes as obersevation_function
    ...
    # File path for saving data
        self.csv_file_path = r'C:\Users\danie\OneDrive\Dokumenter\MasterThesis\Test\csvfile.csv'
        ...
        header = [
            'Time', 'zn0_temp', 'zn1_temp', 'zn2_temp', 'fan_electric_power', 'fan_mass_flow',
            'CO2_indoor_zn0', 'CO2_indoor_zn2', 'Occupancy_schedule'
        ]
        self.csv_writer.writerow(header)

        # Simulation control
        self.data_collection_complete = False
        self.max_timesteps = 24 * 6 * 31  # Example: One month of data (31 days * 24 hours * 6 timesteps/hour)
    ...
    def observation_function(self):
        ...
        if self.time < datetime.datetime.now():
            ...
            # Write data to the CSV file at each timestep
            self.csv_writer.writerow([
                self.time, self.zn0_temp, self.zn1_temp, self.zn2_temp, self.fan_electric_power, self.fan_mass_flow,
                self.CO2_indoor_zn0, self.CO2_indoor_zn2, self.Occupancy_schedule
            ])
...
# Define thresholds - Can find example in model_test.py.
    ...
    def act(self, state):
           ...
           if co2_indoor_con > 0.9:
               ...
               action = 10          # Medium fan speed
           else:
               action = 10        # Full speed fan
