...
# -- FILE PATHS --
# * E+ Download Path *
ep_path = 'C:\EnergyPlusV24-1-0'  # path to E+ on system
...
# idf_file_name = r"C:\Users\danie\OneDrive\Dokumenter\MasterThesis\Test\ReMoni_OS_Model.idf"  # building energy model (BEM) IDF file
# Weather Path
...
# ep_weather_path = r"C:\Users\danie\OneDrive\Dokumenter\MasterThesis\Test\DNK_MJ_Aarhus.AP.060700_TMYx.2007-2021.epw" #  EPW weather file entire year
...
# Define thresholds - Can find example in model_test.py.
    ...
    # def act(self, state):
        ...
        # state_scalar = state[0]  # Extract the scalar value from the array
        # if state_scalar < 0.25 or state_scalar > 0.75:  # Night time 
        #     action = 10
        # # elif 0.25 < state_scalar >= 0.3:
        # #     action = 5
